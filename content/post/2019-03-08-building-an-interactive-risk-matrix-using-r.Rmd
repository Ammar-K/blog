...
<<<<<<< HEAD
> Sometime the risk matrix is defined as a tool to evaluate risk... and that is a dangerous thing to do, [see](https://kazarians.com/wp-content/uploads/2018/03/Busby_Risk-Matrix-Pitfalls_180302.pdf)
=======
...
config(ggplotly(risk_p,tooltip = "text", width = 750,height = 750), displayModeBar=FALSE, collaborate = FALSE) %>%
