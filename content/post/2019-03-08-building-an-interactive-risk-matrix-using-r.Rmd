...
header:
  caption: 'ammar'
  image: '/post/2019-03-08-building-an-interactive-risk-matrix-using-r_files/risk_matrix.jpg'
  preview: yes
---

![]("https://neo-reliability.com/img/risk_matrix.jpg")



![](/post/2019-03-08-building-an-interactive-risk-matrix-using-r_files/risk_matrix.jpg)
...
Sometime the risk matrix is defined as a tool to evaluate risk... and that is a dangerous thing to do (reference)

# What will we do today

In the this example, the risk matrix is used as a tool to visualize the risk in an interactive way.

I'll include few things:
